 ...
 */
vector<int> filteredCoordinates(const vector<int>& arr, int coordinate, int s, int t) {
    vector<int> result;
    for (int item : arr) {
        int curItem = item + coordinate;
        if (curItem >= s && curItem <= t) {
...
void countApplesAndOranges(int s, int t, int a, int b, vector<int> apples, vector<int> oranges) {
      ...
      vector<int> applesCoordinates = filteredCoordinates(apples, a, s, t);
    vector<int> orangesCoordinates = filteredCoordinates(oranges, b, s, t);

    cout << applesCoordinates.size() << endl;
    cout << orangesCoordinates.size() << endl;
}
